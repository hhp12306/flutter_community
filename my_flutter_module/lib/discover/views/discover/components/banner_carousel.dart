...
/// Banner 点击回调
typedef OnBannerTap = void Function(int index, BannerModel banner);

/// Banner轮播图组件
class BannerCarousel extends StatefulWidget {
  final List<BannerModel> banners;
  final ValueChanged<int?>? onThemeStyleChanged;
        ...
        return Builder(
          builder: (BuildContext context) {
            return GestureDetector(
              onTap: () {
                widget.onBannerTap?.call(index, banner);
                if (widget.onBannerTap == null && banner.linkUrl != null) {
                  // TODO: 按 linkUrl 跳转
                }
              },
              child: Container(
