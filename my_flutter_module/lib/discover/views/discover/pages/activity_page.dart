...
import '../../common/thumb_asset_image.dart';

/// 活动卡片封面使用的静态图片路径（图片需放在 assets/images/ 下）
  ...
  Widget _buildActivityCard(ActivityModel activity) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          // 活动封面图（ThumbAssetImage，thumbParams 为空则直接使用 source）
          ClipRRect(
            borderRadius: const BorderRadius.only(
              topLeft: Radius.circular(12.0),
              topRight: Radius.circular(12.0),
            ),
            child: ThumbAssetImage(
              source: _activityCoverAsset,
